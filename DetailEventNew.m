...
@interface DetailEventNew ()< MKMapViewDelegate,  CLLocationManagerDelegate ,UITabBarDelegate,UIWebViewDelegate>
...
- (void)viewDidLoad {
    ...
    [homeBtn setImage:[UIImage imageNamed:@"bookmarkDetail"] forState:UIControlStateNormal];
    ...
    [homeBtn setImage:[UIImage imageNamed:@"bookMarkDetail_Selected"] forState:UIControlStateSelected];
    
    settingsBtn =  [UIButton buttonWithType:UIButtonTypeCustom];
    [settingsBtn setImage:[UIImage imageNamed:@"likeDetail"] forState:UIControlStateNormal];
    ...
    [settingsBtn setImage:[UIImage imageNamed:@"likeDetail_selected"] forState:UIControlStateSelected];
...
- (void)BookMarkWithId:(id)sender{
    ...
    [manager POST:@"http://zenparent.in/api/bookmark"parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([sender isSelected]) {
            [sender setImage:[UIImage imageNamed:@"bookmarkDetail"] forState:UIControlStateNormal];
            [sender setSelected:NO];
        } else {
            [sender setImage:[UIImage imageNamed:@"bookMarkDetail_Selected"] forState:UIControlStateSelected];
...
-(void)LikedWithId:(id)sender{
    ...
    [manager POST:@"http://zenparent.in/api/like" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([sender isSelected]) {
            [sender setImage:[UIImage imageNamed:@"likeDetail"] forState:UIControlStateNormal];
            [sender setSelected:NO];
        } else {
            [sender setImage:[UIImage imageNamed:@"likeDetail_selected"] forState:UIControlStateSelected];
            [sender setSelected:YES];
        }

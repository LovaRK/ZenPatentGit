...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
   ...
   // cell.recipeTitle.text = @"rama krishna";
    ...
    [cell.boockMarkedPressed setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
    
    [cell.boockMarkedPressed setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
    
    [cell.likeButtonPressed setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
    
    [cell.likeButtonPressed setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];

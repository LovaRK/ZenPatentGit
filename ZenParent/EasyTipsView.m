...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.bookMarkedButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
    
    [cell.bookMarkedButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];

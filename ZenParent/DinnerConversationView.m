...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.bookMarkButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
    
    [cell.bookMarkButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];

...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([type isEqualToString: CellIdentifier]) {
        ...
        [mycell1.bookMarkButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
        
        [mycell1.bookMarkButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
        
        [mycell1.likePressedButton setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        
        [mycell1.likePressedButton setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        [mycell2.boockMarkedButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
        
        [mycell2.boockMarkedButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
        
        [mycell2.likeButton setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        
        [mycell2.likeButton setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        [mycell3.bookMarkedButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
        
        [mycell3.bookMarkedButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
        
        [mycell3.likeButtonPressed setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        
        [mycell3.likeButtonPressed setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        [mycell4.boockMarkButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
        
        [mycell4.boockMarkButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
        
        [mycell4.likeButton setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        
        [mycell4.likeButton setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        [mycell5.bookMarkedButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
        
        [mycell5.bookMarkedButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
        
        [mycell5.likedButton setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        
        [mycell5.likedButton setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        [mycell6.bookMarkButton setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
        
        [mycell6.bookMarkButton setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
        
        [mycell6.likeButton setImage:[UIImage imageNamed:@"like"] forState:UIControlStateNormal];
        
        [mycell6.likeButton setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        
    {
        ...
        [manager POST:@"http://zenparent.in/api/like" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
                ...
                
            {
                ...
                [sender setImage:[UIImage imageNamed:@"like_selected"] forState:UIControlStateSelected];
        ...
        [manager POST:@"http://zenparent.in/api/bookmark" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
                ...
                
            {
                ...
                if (IS_IPAD)
                {
                    ...
                    [sender setImage:[UIImage imageNamed:@"bookmark_selected"] forState:UIControlStateSelected];
                }
                ...
                
            {
                ...
                if (IS_IPAD)
                {
                    [sender setImage:[UIImage imageNamed:@"bookmark"] forState:UIControlStateNormal];
